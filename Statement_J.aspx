<%@ Page Language="C#" MasterPageFile="~/Class2.Master" AutoEventWireup="true" CodeBehind="Statement_J.aspx.cs" Inherits="Project_Management_Information_System1._0.Statement_J" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Statements - Adjustments</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="right_col" role="main">
        ...
        <% if ((int)SI.Statement_J <= (int)Project_Management_Information_System1._0.Access_Type.View_2)
            { %>
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <% if (SI.Statement_J == Project_Management_Information_System1._0.Access_Type.Edit_1)
                                            { %>
                                        <th>
                ...
                <div class="x_content">
                    <div id="pb02">
                        <div class="portlet-body">
                            <div style="font-size:12pt;">
                                <div class="form-inline text-center">
                                    ...
                                    <button id="btnaddnewstatement" class="btn btn-success pull-right" runat="server" onserverclick="btnaddnewstatement_Click">Create New<span class="glyphicon glyphicon-plus"></span></button>                                            
                                    <span style="padding-right:20px;">Statement Date : </span>
                                    ...
                                    <div class="panel-body">
                                        <table class="table table-bordered table-advanced">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>R</td>
                                                    <td><input type="text" id="txtIP_Rial1" runat="server" class="form-control" placeholder="R" style="font-size:13pt;" dir="ltr" /></td>
                                                    <td><input type="text" id="txtIP_Rial_C" runat="server" class="form-control" placeholder="Total R" style="font-size:13pt;" dir="ltr" /></td>
                                                    <td><input type="text" id="txtIP_Date1" runat="server" class="form-control" placeholder="Date" style="font-size:13pt;" /></td>
                                                </tr>
                                                <tr>
                                                    <td>Euro</td>
                                                    <td><input type="text" id="txtIP_Euro1" runat="server" class="form-control" placeholder="Euro" style="font-size:13pt;" dir="ltr" /></td>
                                                    <td><input type="text" id="txtIP_Euro_C" runat="server" class="form-control" placeholder="Total Euro" style="font-size:13pt;" dir="ltr" /></td>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>R</td>
                                                    <td><input type="text" id="txtCS_Rial1" runat="server" class="form-control" placeholder="R" style="font-size:13pt;" dir="ltr" /></td>
                                                    <td><input type="text" id="txtCS_Rial_C" runat="server" class="form-control" placeholder="Total R" style="font-size:13pt;" dir="ltr" /></td>
                                                    <td><input type="text" id="txtCS_Date1" runat="server" class="form-control" placeholder="Date" style="font-size:13pt;" /></td>
                                                </tr>
                                                <tr>
                                                    <td>Euro</td>
                                                    <td><input type="text" id="txtCS_Euro1" runat="server" class="form-control" placeholder="Euro" style="font-size:13pt;" dir="ltr" /></td>
                                                    <td><input type="text" id="txtCS_Euro_C" runat="server" class="form-control" placeholder="Total Euro" style="font-size:13pt;" dir="ltr" /></td>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>R</td>
                                                    <td><input type="text" id="txtCC_Rial1" runat="server" class="form-control" placeholder="R" style="font-size:13pt;" dir="ltr" /></td>
                                                    <td><input type="text" id="txtCC_Rial_C" runat="server" class="form-control" placeholder="Total R" style="font-size:13pt;" dir="ltr" /></td>
                                                    <td><input type="text" id="txtCC_Date1" runat="server" class="form-control" placeholder="Date" style="font-size:13pt;" /></td>
                                                </tr>
                                                <tr>
                                                    <td>Euro</td>
                                                    <td><input type="text" id="txtCC_Euro1" runat="server" class="form-control" placeholder="Euro" style="font-size:13pt;" dir="ltr" /></td>
                                                    <td><input type="text" id="txtCC_Euro_C" runat="server" class="form-control" placeholder="Total Euro" style="font-size:13pt;" dir="ltr" /></td>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>R</td>
                                                    <td><input type="text" id="txtTC_Rial1" runat="server" class="form-control" placeholder="R" style="font-size:13pt;" dir="ltr" /></td>
                                                    <td><input type="text" id="txtTC_Rial_C" runat="server" class="form-control" placeholder="Total R" style="font-size:13pt;" dir="ltr" /></td>
                                                    <td><input type="text" id="txtTC_Date1" runat="server" class="form-control" placeholder="Date" style="font-size:13pt;" /></td>
                                                </tr>
                                                <tr>
                                                    <td>Euro</td>
                                                    <td><input type="text" id="txtTC_Euro1" runat="server" class="form-control" placeholder="Euro" style="font-size:13pt;" dir="ltr" /> </td>
                                                    <td><input type="text" id="txtTC_Euro_C" runat="server" class="form-control" placeholder="Total Euro" style="font-size:13pt;" dir="ltr" /></td>
                        ...
                        <div class="panel-footer">
                            <div class="form-inline text-center">
                                <button class="btn btn-success" id="btnSave1" runat="server" onserverclick="btnSave1_Click">Save <i class="glyphicon glyphicon-floppy-disk"></i></button>                                        
                            </div>
                        </div>
                        </div>
                </div>                        
        ...
        <% } %>
        <% if ((int)SI.Statement_J <= (int)Project_Management_Information_System1._0.Access_Type.View_1)
           { %>
